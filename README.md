...
本博客列表也提供同步更新的OPML文件（[下载OPML文件](https://github.com/tangqiaoboy/iOSBlogCN/blog/master/blogcn.opml)），可供导入到例如feedly等第三方定阅工具中，特别感谢 [lcepy](https://github.com/lcepy) 提供。这里有[导入教程](http://blog.feedly.com/feedlimport/)。
